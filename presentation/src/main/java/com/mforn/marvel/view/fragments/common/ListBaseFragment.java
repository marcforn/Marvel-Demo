...
/**
 * List Base fragment to handle activity communication and dependency injection.
 */
public class ListBaseFragment extends Fragment {
    protected ListActivityInterface mListener;
    ...
    private void onAttachToContext(Context context) {
        try {
            mListener = (ListActivityInterface) context;
