...
import com.mforn.marvel.presenter.CharacterDetailPresenter;
...
/**
 * Fragment that shows details of a certain Marvel character.
 */
public class CharacterDetailFragment extends DetailBaseFragment implements View.OnClickListener, CharacterDetailDataView<CharacterDetailModel> {
    ...
    @Inject
    CharacterDetailPresenter mPresenter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View fragmentView = inflater.inflate(R.layout.fragment_character_detail, container, false);
    ...
    public void showData(CharacterDetailModel characterDetailModel) {
        ...
        Glide.with(getActivity())
                .load(characterDetailModel.getLandscapeImageUrl())
                .into(characterImage);
